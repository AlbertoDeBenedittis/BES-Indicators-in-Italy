...
def folium_interactive_map(df, var, file_name, indicator):
    ...
    m10=folium.Map(location=[41.9027835,12.4963655],tiles='openstreetmap',zoom_start=6)
...
def folium_interactive_map2(df, var, file_name, indicator):
    '''
...
''' # Design the choropletmap 
    ...
    fill_opacity=0.8, 
    line_opacity=1,
    legend_name='INDICATORE', # NEEDS TO  BE CHANGED 
    smooth_factor=0).add_to(m10)'''
